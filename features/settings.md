...
![&apos;Settings&apos; page](../.gitbook/assets/image%20%2834%29.png)
...
![&apos;Settings-Application Info&apos; page](../.gitbook/assets/image%20%2810%29.png)
...
![&apos;Settings-API&apos; page](../.gitbook/assets/image%20%2825%29.png)

### IP Blacklist

* **IP Blacklist:** Shows blocked IPs from all APIs access.

![&apos;Settings-IP Blacklist&apos; page](../.gitbook/assets/image%20%2865%29.png)

### Regions

* **Regions:** You can choose servers in multiple regions. API requests are routed to a server that has a faster response rate.

![&apos;Settings-Regions&apos; page](../.gitbook/assets/image%20%2859%29.png)
